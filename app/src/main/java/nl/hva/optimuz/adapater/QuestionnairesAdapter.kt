...
class QuestionnairesAdapter (context: Context?, val questionnaires : List<Questionnaire>,
                             private val listener: OnItemClickListener) : RecyclerView.Adapter<QuestionnairesAdapter.QuestionnaireViewHolder>(){
    ...
    override fun onBindViewHolder(holder: QuestionnaireViewHolder, position: Int) {
        ...
        holder.itemView.textViewIsNew.visibility = if(questionnaire.isNew) View.VISIBLE else View.INVISIBLE
